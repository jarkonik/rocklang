...
macro_rules! assert_angle_brackets_foramt_string {
...
fn it_assert_token_types_formatng() {
    assert_angle_brackets_foramt_string!(Identifier, "ident".to_string(), "<Identifier(ident)>");
    assert_angle_brackets_foramt_string!(Numeric, 10.0, "<Numeric(10)>");
    assert_angle_brackets_foramt_string!(String, "string".to_string(), "<String(string)>");
